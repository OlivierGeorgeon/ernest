...
//		tactileSimulations[0] = m_spas.addStimulation(Ernest.MODALITY_TACTILE, stimuli[0][9], LocalSpaceMemory.DIRECTION_BEHIND_RIGHT);
		...
		// TODO remove Ernest 100 !!!!
		IObservation newObservation = m_spas.step(tactileStimulations, kinematicStimulation, gustatoryStimulation);
	...
	/**
	 * Compute the impulsion value associated with the next intention schema.
	 * @param intentionSchema The enacted schema.
	 */
