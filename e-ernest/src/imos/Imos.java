...
{	
	 ...
	 * A low value favors the fast adoption of possibly less satisfying habits, 
	 * a high value favors the slow adoption of possibly more satisfying habits.
	 * @param maxShemaLength The maximum length of schemas.
	 * A low value makes learning long sequences impossible, 
	 * a high value makes possible the adoption of unnecessarily long sequences.
	 */
...
//		return a;
	 ...
	 * or retrieve the interaction if it already exists.
	 ...
	 * @param stimuliLabel The label of the interaction's stimuli generated by the action (may be null or "").
	 * @param status The interaction's status true=succeed, false =fail.
	 * @param satisfaction The interaction's satisfaction (only needed in case the previous interaction was not 
