 ...
 * @author ogeorgeon
 */
public class Roesch3 implements IEnvironment 
{
...
//			effect = uturn();
	...
	public void initErnest(IErnest ernest) {
		ernest.addInteraction(">", "t", 4); // up
		ernest.addInteraction(">", "f", -10); // down
		ernest.addInteraction("-", "t", -4); // feel up
		ernest.addInteraction("-", "f", -4); // feel down
		//ernest.addInteraction("u", "t", -3); // UTurn
		ernest.addInteraction("i", "t", 4); // toggle
		ernest.addInteraction("i", "f", -10); // nop
	}
